export default {
    ...
    nycatai: {
        ...
        copilot: {
            title: "编排助手",
            open: "打开编排助手（AI 直接操作画布）",
            empty: "描述你想要的画面或工作流，我会直接在画布上建节点、连线并触发生成。例：为一款咖啡品牌出 4 张分镜，先定人设再出图。",
            placeholder: "让 AI 帮你编排画布…",
            toolRunning: "正在执行 {{name}}",
            confirmTitle: "该操作包含删除，确认执行？",
            confirmApply: "执行",
            confirmCancel: "拒绝",
            undo: "撤销上一批画布操作",
            clear: "清空对话",
            needKey: "对话模型未配置：请从主站一键拉起，或在配置里给 NYCATAI 对话渠道填入密钥。",
            error: "编排失败",
            contextLost: "画布上下文已失效，请回到画布页重试",
        ...
        templates: {
            entry: "模板",
            title: "NYCATAI 模板画廊",
            hint: "一键克隆精品工作流到本地画布：改掉【占位提示词】即可生成，或直接让「编排助手」按模板帮你出图。",
            clone: "一键克隆",
        },
    },
    theme: { toggle: "切换主题" },
    ...
    imageWorkbench: {
        tooManyInFlight: "最多同时跑 {{count}} 批，等一批完成再发",
        inFlight: "{{count}} 批在途",
        title: "生图工作台",
    ...
    chat: {
        title: "对话",
        subtitle: "用文本模型打磨提示词、拆分镜、改文案",
        placeholder: "问点什么…（Enter 发送，Shift+Enter 换行）",
        empty: "这里是纯文本对话：帮你写生图/视频提示词、拆分镜、改文案。想让 AI 直接在画布上建节点、连线、出图，请用画布页左下角的「编排助手」。",
        thinking: "思考中…（已等待 {{seconds}} 秒）",
        clear: "清空对话",
        error: "对话失败",
        needKey: "对话模型未配置：请从主站「无限画布」入口一键进入，即可自动完成配置。",
        footerHint: "为控制费用，每次只上传最近 20 条对话作为上下文；会话保存在本浏览器，不上传服务器。",
        suggestions: {
            poster: "帮我写一条电商主图提示词",
            storyboard: "把这个故事拆成 9 个分镜",
            video: "写一条运镜丰富的视频提示词",
            polish: "把我这段提示词改得更具体",
        },
    },
