export default {
    ...
    nycatai: {
        ...
        copilot: {
            title: "Copilot",
            open: "Open canvas copilot (AI operates the canvas)",
            empty: "Describe the visuals or workflow you want; I'll create nodes, wire them and trigger generation directly on the canvas.",
            placeholder: "Let AI orchestrate the canvas…",
            toolRunning: "Running {{name}}",
            confirmTitle: "This batch contains deletions. Proceed?",
            confirmApply: "Apply",
            confirmCancel: "Reject",
            undo: "Undo last batch of canvas ops",
            clear: "Clear conversation",
            needKey: "Chat model not configured: launch from the NYCATAI console, or set an API key on the NYCATAI chat channel.",
            error: "Orchestration failed",
            contextLost: "Canvas context lost; go back to the canvas page and retry",
        ...
        templates: {
            ...
            hint: "Clone curated workflows into your canvas. Replace the [placeholder prompts], or ask the Copilot to run the template for you.",
            clone: "Clone",
        },
    },
    ...
    chat: {
        title: "Chat",
        subtitle: "Draft prompts, break down storyboards, and polish copy with a text model",
        placeholder: "Ask anything… (Enter to send, Shift+Enter for a new line)",
        empty: "Plain text chat: it helps you write image/video prompts, split storyboards, and polish copy. To have AI build nodes and generate directly on the canvas, use the Copilot in the canvas page.",
        thinking: "Thinking… ({{seconds}}s)",
        clear: "Clear conversation",
        error: "Chat failed",
        needKey: "No text model configured. Open the canvas from the NYCATAI site to have it set up automatically.",
        footerHint: "Only the last 20 messages are sent as context to keep cost down. The conversation stays in this browser.",
        suggestions: {
            poster: "Write a prompt for an e-commerce hero image",
            storyboard: "Split this story into 9 shots",
            video: "Write a video prompt with rich camera motion",
            polish: "Make my prompt more specific",
        },
    },
    topNav: {
